...
public class MoyenActivity extends AppCompatActivity implements View.OnTouchListener {
    ...
    public static void Nombres_Masque(int[] nombres, int[] vrai, boolean[] masque) {
        for (int i = 0; i < 81; i++) {
            if (masque[i] == true) {
                nombres[i] = 0;
            } else {
    ...
    public void victoire() {
        Intent myIntent = new Intent(MoyenActivity.this, VictoireActivity.class);
        MoyenActivity.this.startActivity(myIntent);
        finish();
    }
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Log.e("qwr", "moyen");
        Log.e("qwe", (difficulter.equals("moyen")) + "");
...
//===============================================================================================//
                ...
                num01.setX(crds[0]);
                num01.setY(crds[1] - 120);
                num01wh.setX(crds[0]);
                num01wh.setY(crds[1] - 120);
                num02.setX(crds[0] + 50);
                num02.setY(crds[1] - 112);
                num02wh.setX(crds[0] + 50);
                num02wh.setY(crds[1] - 112);
                num03.setX(crds[0] + 60);
                num03.setY(crds[1] - 60);
                num03wh.setX(crds[0] + 60);
                num03wh.setY(crds[1] - 60);
                num04.setX(crds[0] + 60);
                num04.setY(crds[1] - 10);
                num04wh.setX(crds[0] + 60);
                num04wh.setY(crds[1] - 10);
                num05.setX(crds[0] + 55);
                num05.setY(crds[1] + 40);
                num05wh.setX(crds[0] + 55);
                num05wh.setY(crds[1] + 40);
                num06.setX(crds[0] - 55);
                num06.setY(crds[1] + 40);
                num06wh.setX(crds[0] - 55);
                num06wh.setY(crds[1] + 40);
                num07.setX(crds[0] - 60);
                num07.setY(crds[1] - 10);
                num07wh.setX(crds[0] - 60);
                num07wh.setY(crds[1] - 10);
                num08.setX(crds[0] - 60);
                num08.setY(crds[1] - 60);
                num08wh.setX(crds[0] - 60);
                num08wh.setY(crds[1] - 60);
                num09.setX(crds[0] - 50);
                num09.setY(crds[1] - 112);
                num09wh.setX(crds[0] - 50);
                num09wh.setY(crds[1] - 112);
            ...
            case MotionEvent.ACTION_MOVE:
                ...
                break;
            case MotionEvent.ACTION_UP: // mouvement lâche prise
                v.setBackgroundColor(Color.GREEN);
                vw.setTextColor(0xFF555555);
                if (Math.sqrt((x - x0) * (x - x0) + (y - y0) * (y - y0)) >= 50) {
                    TextView currentCell = (TextView) v;
                    currentCell.setText(nomb + "");
                    String strid = (currentCell.getResources().getResourceName(currentCell.getId()));
