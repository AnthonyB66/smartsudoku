...
public class GameActivity extends AppCompatActivity implements View.OnTouchListener {
    ...
    //appel des fonctions precedente pour le mélange total du tableau
    ...
    //Focntion pour créer une grille selon la difficultée choisi par l'utilisateur
    public void niveau(boolean[] arr, String diff) {
        if (diff.equals("facile")) {


            int[] indexarr = new int[30];
            for (int i = 0; i < 30; i++) {
    ...
    //Fonction pour indiquer les cases vide de la grille
    ...
    //Fonction qui envoi la victoire
    public void victoire()
    {
        Intent myIntent = new Intent(GameActivity.this, VictoireActivity.class);
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        //mélange au hasard le tableau et forme une combinaison gagnante
        melange(nbrVrai);
        //creation du niveau avec des case vide ou non
...
//===============================================================================================//
    ...
    {
        //appel des icones pour la roulette de sélection
        ImageView num01 = findViewById(R.id.num01);
...
//===============================================================================================//
                ...
                break;//mouvement des icônes numwh selon si l'utilsateur appui dessus
            ...
            case MotionEvent.ACTION_UP: // mouvement lâche prise
                ...
                //desactiavtion des num et numwh
